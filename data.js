const data = {
  futbol: [
    ...
    },
    {
      ...
      contenido: `
        <p>El Real Madrid derrotó al Manchester City 2-1 con goles de Vinícius Jr. y Bellingham, consiguiendo su título número 15 en la UEFA Champions League.</p>
      ...
      imagen: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Real_Madrid_CF.svg/1024px-Real_Madrid_CF.svg.png"
    }
  ],
  basquetbol: [
    {
    ...
    },
    {
      ...
      contenido: `
        <p>El All-Star Game 2025 se celebrará en Chicago y contará con la presencia de las grandes figuras de la NBA.</p>
        <p>Stephen Curry, Luka Dončić y Giannis Antetokounmpo encabezan la lista de convocados por el público.</p>
  ...
  tenis: [
    {
      ...
      lugar: "Londres, Inglaterra",
      imagen: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.marca.com%2Ftenis%2Fwimbledon%2F2024%2F06%2F27%2F667d1c0546163fcc7a8b458c.html&psig=AOvVaw1UkT4Ejb5EF4gb9Nf3GBEC&ust=1746833259190000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCLD76JODlY0DFQAAAAAdAAAAABAE"
    },
    {
